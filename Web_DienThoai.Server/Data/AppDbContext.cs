...
public class AppDbContext : IdentityDbContext<AppUser>
{
 ...
 public DbSet<OrderItem> OrderItems => Set<OrderItem>();
    ...
    public DbSet<HomeMerchandisingConfig> HomeMerchandisingConfigs => Set<HomeMerchandisingConfig>();
    public DbSet<HomeMerchandisingVersion> HomeMerchandisingVersions => Set<HomeMerchandisingVersion>();
...
// ── WishlistItem ──────────────────────────────────────
     builder.Entity<WishlistItem>()
        ...
        builder.Entity<HomeMerchandisingConfig>()
            .HasKey(c => c.Id);

        builder.Entity<HomeMerchandisingVersion>()
            .HasKey(c => c.Id);
    }
}
